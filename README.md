...
We also include the library as part of this artifact in the `src` folder. The version included in this artifact is also available under the following git tag: [https://github.com/stg-tud/Bismuth/tree/2026-prdt-oopsla26-artifact](https://github.com/stg-tud/Bismuth/tree/2026-prdt-oopsla26-artifact).
